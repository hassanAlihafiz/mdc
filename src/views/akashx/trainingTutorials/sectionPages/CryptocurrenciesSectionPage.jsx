...
export default function CryptocurrenciesSectionPage(props) {
  ...
  useEffect(() => {
    ...
    scriptParam.innerHTML = `TraducationFX("book.cryptocurrencies", "configure", {
      "containerId": "trfx-cryptocurrencies",
      "bookSlug": "cryptocurrencies"
    });
    TraducationFX("book.cryptocurrencies", "embed");`
  ...
  return (
    <Wrapper>
      <div id="trfx-cryptocurrencies"></div>
    </Wrapper>
  )
}

...
export default function CryptoSection(props) {
  ...
  useEffect(() => {
    ...
    scriptParam.innerHTML = `TraducationFX("cryptoCalendar", "configure", {
      "containerId": "trfx-crypto-calendar"
    });
  ...
  return (
    <Wrapper>
      <div id="trfx-crypto-calendar"></div>
    </Wrapper>
  )
}

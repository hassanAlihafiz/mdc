...
export default function PlatformTutorialsSection(props) {
  ...
  useEffect(() => {
    ...
    scriptParam.innerHTML = `TraducationFX("video.all-platform-tutorials-guide-incl-in-depth-full-access", "configure", {
      "containerId": "trfx-all-platform-tutorials-guide-incl-in-depth-full-access",
      "playlistKey": "OdqFZQjpFG2",
      "thumbnailSet": "default",
      "layout": "vertical-tabs"
    });
    TraducationFX("video.all-platform-tutorials-guide-incl-in-depth-full-access", "embed");`
  ...
  return (
    <Wrapper>
      <div id="trfx-all-platform-tutorials-guide-incl-in-depth-full-access"></div>
    </Wrapper>
  )
}

...
export default function BeginnerSection(props) {
  ...
  useEffect(() => {
    ...
    scriptParam.innerHTML = `TraducationFX("video.beginners-guide-incl-in-depth-full-access", "configure", {
      "containerId": "trfx-beginners-guide-incl-in-depth-full-access",
      "playlistKey": "2VqIuXa5zts",
      "thumbnailSet": "default",
      "layout": "vertical-tabs"
    });
    TraducationFX("video.beginners-guide-incl-in-depth-full-access", "embed");`
  ...
  return (
    <Wrapper>
      <div id="trfx-beginners-guide-incl-in-depth-full-access"></div>
    </Wrapper>
  )
}

...
export default function CryptocurrenciesSection(props) {
  ...
  useEffect(() => {
    ...
    scriptParam.innerHTML = `TraducationFX("video.cryptocurrencies-guide-incl-in-depth-full-access", "configure", {
      "containerId": "trfx-cryptocurrencies-guide-incl-in-depth-full-access",
      "playlistKey": "RxtQR0lr6Qq",
      "thumbnailSet": "default",
      "layout": "vertical-tabs"
    });
    TraducationFX("video.cryptocurrencies-guide-incl-in-depth-full-access", "embed");`
  ...
  return (
    <Wrapper>
      <div id="trfx-cryptocurrencies-guide-incl-in-depth-full-access"></div>
    </Wrapper>
  )
}

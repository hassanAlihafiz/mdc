...
export default function ExpertSection(props) {
  ...
  useEffect(() => {
    ...
    scriptParam.innerHTML = `TraducationFX("video.experts-guide-incl-in-depth-full-access", "configure", {
      "containerId": "trfx-experts-guide-incl-in-depth-full-access",
      "playlistKey": "35e9Rh4BYJj",
      "thumbnailSet": "default",
      "layout": "vertical-tabs"
    });
    TraducationFX("video.experts-guide-incl-in-depth-full-access", "embed");`
  ...
  return (
    <Wrapper>
      <div id="trfx-experts-guide-incl-in-depth-full-access"></div>
    </Wrapper>
  )
}

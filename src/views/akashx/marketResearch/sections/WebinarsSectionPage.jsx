...
export default function WebinarsSectionPage(props) {
  ...
  useEffect(() => {
    ...
    scriptParam.innerHTML = `TraducationFX("marketResearchVideos", "configure", {
      "containerId": "trfx-research-videos",
      "layout": "grid"
    });
  ...
  return (
    <Wrapper>
      ...
      <div id="trfx-research-videos"></div>
    </Wrapper>
  )
}

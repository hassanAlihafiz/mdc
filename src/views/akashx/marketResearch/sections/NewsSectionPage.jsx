...
export default function NewsSectionPage(props) {
  ...
  useEffect(() => {
    ...
    scriptParam.innerHTML = `TraducationFX("articles.marketNews", "configure", {
      "containerId": "trfx-marketNews",
      "category": "marketNews",
      "layout": "grid"
    });
    TraducationFX("articles.marketNews", "embed");`

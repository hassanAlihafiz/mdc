...
import { Wrapper } from "../add/AddModal.styled";
...
export default function EditModal(props) {
  ...
  const handleSubmit = () => {
    ...
    callPutApiWithAuth(`my_website/share_cart/${props.selected.id}`, body, 
  ...
  useEffect(() => {
    ...
    setDetails(props.selected.details)
  }, [props.selected])

  return (
    <Modal title='Edit Sharable Cart'
      width={900}
